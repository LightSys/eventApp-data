<nav>
    <ol>
        ...
        <a href="housing.php"><li id="housing">Housing</li></a>
        <a href="prayer-partners.php"><li id="prayer-partners">Prayer Partners</li></a>
        <a href="advanced.php"><li id="advanced">Advanced</li></a>
    </ol>
</nav>