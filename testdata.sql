...
insert into housing(event_ID, host_name, driver) values (1, 'Godzilla', 'Baby');
insert into prayer_partners(event_ID) values (1);
insert into attendees(house_ID, prayer_group_ID, name) values (1, 1, 'First Last');
